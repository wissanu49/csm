        ...
        <td colspan="2">
            <table class="table" >
                <tr style="text-align: center;">
                    <td style="width: 5%;text-align: center;"><h5><strong>#</strong></h5></td>
                    <td style="width: 35%;text-align: left;"><h5><strong>รายการ</strong></h5></td>
                    <td style="width: 10%;text-align: center;"><h5><strong>จำนวน</strong></h5></td>
                    <td style="width: 15%;text-align: center;"><h5><strong>ราคา</strong></h5></td>
                    <td style="width: 15%;text-align: center;"><h5><strong>เวลาฝาก</strong></h5></td>
                    <td style="width: 10%;text-align: center;"><h5><strong>รวม</strong></h5></td>
                </tr>
                <?php
                $i = 1;
                $total = 0;
