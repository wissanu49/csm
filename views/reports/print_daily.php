        ...
        <div class="box">
            ...
            <div class="box-body no-padding">
                <table class="table table-bordered">
                    ...
                    <td style="width: 55px;text-align: center;"><strong>รายการ</strong></td>
                    <td style="width: 15px;text-align: center;"><strong>จำนวน</strong></td>                    
                    <td style="width: 15px;text-align: center;"><strong>รายได้</strong></td>
                    </tr>
                    <?php
                    $i = 0;
                    $total = 0;
